...
```{r echo=FALSE, out.width='25%', fig.align = "center", fig.cap = "Logo do pacote [**magrittr**](https://github.com/tidyverse/magrittr) com a frase ***Ceci n'est pas une pipe*** ([**ouça a pronuncia**](files/audio_magrittr.ogg), mesmo frase que acompanha a pintura ***La trahison des images*** de [**René Magritte**](https://pt.wikipedia.org/wiki/Ren%C3%A9_Magritte)."}
