...
```{r diagramafluxo, echo = FALSE, message = FALSE, warning = FALSE, fig.align = 'center', fig.cap = 'Fluxo de trabalho - organização dos dados, escolhas das metodologias, implementações e edição de documento.'}
library(DiagrammeR)
mermaid("
graph TD
...
```{r diagramafluxor, echo = FALSE, message = FALSE, warning = FALSE, fig.align = 'center', fig.cap = 'Linguagem [**R**](https://www.r-project.org) entre todos os fluxos de trabalho de um estudo estatístico. Destaque para o uso de [**R**](https://www.r-project.org) para a construção de um relatório.'}
library(DiagrammeR)
mermaid("
graph TD
...
```{r logomarkdown, echo=FALSE, out.width='40%', fig.align = "center", fig.cap = "Logo da linguagem de marcação [**Markdown**](https://daringfireball.net/projects/markdown/) utilizada para conversão de texto em [**HTML**](https://pt.wikipedia.org/wiki/HTML)."}
knitr::include_graphics("images/logo_markdown.png")
```
...
```{r echo=FALSE, out.width='25%', fig.align = "center", fig.cap="Logo do pacote [**rmarkdown**](https://cran.r-project.org/web/packages/rmarkdown/index.html) - permite programadores [**R**](https://www.r-project.org) extender a sintaxe de marcação [**Markdown**](https://daringfireball.net/projects/markdown/) utilizando [**R Markdown**](https://rmarkdown.rstudio.com/)."}
knitr::include_graphics("images/logo_rmarkdown.png")
```
...
```{r diagramaRmd, echo = FALSE, message = FALSE, warning = FALSE, fig.align = 'center', fig.cap = 'Funcionamento do pacote **rmarkdown** que permite trabalharmos com arquivos .Rmd e sua interação com o **knitr** e **Pandoc** na converção para formatos intermediários.'}
